              ...
              >
                <div className="glass-card rounded-2xl sm:rounded-3xl overflow-hidden h-full flex flex-col border-2 border-transparent group-hover:border-orange-500 transition-all duration-300">
                  ...
                  <div className="p-4 sm:p-6 md:p-8 flex-1 flex flex-col">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-0 pt-3 sm:pt-4 border-t-2 border-gray-100">
                      ...
                      >
                        Read More
                        <ChevronDown className="w-3 h-3 sm:w-4 sm:h-4 rotate-[-90deg] group-hover:translate-x-1 transition-transform" />
                      </motion.a>
                    </div>
                  </div>
                </div>
